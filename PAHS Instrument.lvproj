...
<Project Type="Project" LVVersion="15008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="PAHS Main.vi" Type="VI" URL="../PAHS Main.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Adjust AirPump PWM.vi" Type="VI" URL="../Libraries/Miscellaneous/Adjust AirPump PWM.vi"/>
			<Item Name="AirPump Controls.ctl" Type="VI" URL="../Libraries/Controls/AirPump Controls.ctl"/>
			<Item Name="And More Startup.vi" Type="VI" URL="../Libraries/Initialization/And More Startup.vi"/>
			<Item Name="Aux CO2 Check Zero.vi" Type="VI" URL="../Libraries/Aux CO2/Aux CO2 Check Zero.vi"/>
			<Item Name="Aux CO2 Control.ctl" Type="VI" URL="../Libraries/Controls/Aux CO2 Control.ctl"/>
			<Item Name="Aux CO2 Diags.ctl" Type="VI" URL="../Libraries/Controls/Aux CO2 Diags.ctl"/>
			<Item Name="Aux CO2 Loop.vi" Type="VI" URL="../Libraries/Aux CO2/Aux CO2 Loop.vi"/>
			<Item Name="Aux CO2 Prompt For Zero.vi" Type="VI" URL="../Libraries/Aux CO2/Aux CO2 Prompt For Zero.vi"/>
			<Item Name="Aux CO2 Runtime.vi" Type="VI" URL="../Libraries/Controls/Aux CO2 Runtime.vi"/>
			<Item Name="Aux CO2 Selector.ctl" Type="VI" URL="../Libraries/Controls/Aux CO2 Selector.ctl"/>
			<Item Name="Aux CO2 Serial Check.vi" Type="VI" URL="../Libraries/Aux CO2/Aux CO2 Serial Check.vi"/>
			<Item Name="Aux CO2 Serial Close.vi" Type="VI" URL="../Libraries/Aux CO2/Aux CO2 Serial Close.vi"/>
			<Item Name="Aux CO2 Serial Initialize.vi" Type="VI" URL="../Libraries/Aux CO2/Aux CO2 Serial Initialize.vi"/>
			<Item Name="Aux CO2 Serial Write and Read.vi" Type="VI" URL="../Libraries/Aux CO2/Aux CO2 Serial Write and Read.vi"/>
			<Item Name="Aux CO2 Set LoFlo Compensation.vi" Type="VI" URL="../Libraries/Aux CO2/Aux CO2 Set LoFlo Compensation.vi"/>
			<Item Name="Aux TE Control.ctl" Type="VI" URL="../Libraries/Controls/Aux TE Control.ctl"/>
			<Item Name="Aux TE Controllers Close.vi" Type="VI" URL="../Libraries/Aux TE/Aux TE Controllers Close.vi"/>
			<Item Name="Aux TE Controllers Initialization.vi" Type="VI" URL="../Libraries/Aux TE/Aux TE Controllers Initialization.vi"/>
			<Item Name="Aux TE Controllers Runtime.vi" Type="VI" URL="../Libraries/Aux TE/Aux TE Controllers Runtime.vi"/>
			<Item Name="Aux TE Controllers Serial Write and Read.vi" Type="VI" URL="../Libraries/Aux TE/Aux TE Controllers Serial Write and Read.vi"/>
			<Item Name="Aux TE Controllers Set SetPoints.vi" Type="VI" URL="../Libraries/Aux TE/Aux TE Controllers Set SetPoints.vi"/>
			<Item Name="Build Characterization SetPoint Tables.vi" Type="VI" URL="../Libraries/Miscellaneous/Build Characterization SetPoint Tables.vi"/>
			<Item Name="Build Stored.vi" Type="VI" URL="../Libraries/DAQ/Build Stored.vi"/>
			<Item Name="Build Waveforms.vi" Type="VI" URL="../Libraries/DAQ/Build Waveforms.vi"/>
			<Item Name="Cal Refs.ctl" Type="VI" URL="../Libraries/Controls/Cal Refs.ctl"/>
			<Item Name="Cal Step x.vi" Type="VI" URL="../Libraries/Calibration/Cal Step x.vi"/>
			<Item Name="Cal Step.vi" Type="VI" URL="../Libraries/Calibration/Cal Step.vi"/>
			<Item Name="Calc Ambient Temp.vi" Type="VI" URL="../Libraries/DAQ/Calc Ambient Temp.vi"/>
			<Item Name="Calc Barometric Temp.vi" Type="VI" URL="../Libraries/DAQ/Calc Barometric Temp.vi"/>
			<Item Name="Calc DACs.vi" Type="VI" URL="../Libraries/DAQ/Calc DACs.vi"/>
			<Item Name="Calc Gain and Offset.vi" Type="VI" URL="../Libraries/Calibration/Calc Gain and Offset.vi"/>
			<Item Name="Calc New Setpoint1.vi" Type="VI" URL="../Libraries/Aux TE/Calc New Setpoint1.vi"/>
			<Item Name="Calc Ref CO2.vi" Type="VI" URL="../Libraries/DAQ/Calc Ref CO2.vi"/>
			<Item Name="Calc Tank.vi" Type="VI" URL="../Libraries/Miscellaneous/Calc Tank.vi"/>
			<Item Name="Calc Target Voltages Step 1.vi" Type="VI" URL="../Libraries/Calibration/Calc Target Voltages Step 1.vi"/>
			<Item Name="Calculate C2V.vi" Type="VI" URL="../Libraries/Calculations/Calculate C2V.vi"/>
			<Item Name="Calculate CO2.vi" Type="VI" URL="../Libraries/Calculations/Calculate CO2.vi"/>
			<Item Name="Calculate Flow Rate.vi" Type="VI" URL="../Libraries/Calculations/Calculate Flow Rate.vi"/>
			<Item Name="Calculate PWM.vi" Type="VI" URL="../Libraries/Calculations/Calculate PWM.vi"/>
			<Item Name="Calculate Starting Voltages.vi" Type="VI" URL="../Libraries/Calibration/Calculate Starting Voltages.vi"/>
			<Item Name="Calculate V2C.vi" Type="VI" URL="../Libraries/Calculations/Calculate V2C.vi"/>
			<Item Name="Calibrate 1.vi" Type="VI" URL="../Libraries/States/Calibrate 1.vi"/>
			<Item Name="CalibrateMode.vi" Type="VI" URL="../Libraries/States/CalibrateMode.vi"/>
			<Item Name="Calibration Characterization Mode.vi" Type="VI" URL="../Libraries/States/Calibration Characterization Mode.vi"/>
			<Item Name="Calibration Coefficients.ctl" Type="VI" URL="../Libraries/Controls/Calibration Coefficients.ctl"/>
			<Item Name="Calibration Complete.vi" Type="VI" URL="../Libraries/Calibration/Calibration Complete.vi"/>
			<Item Name="Check For DAQ Update.vi" Type="VI" URL="../Libraries/Miscellaneous/Check For DAQ Update.vi"/>
			<Item Name="Check for Humidity Error.vi" Type="VI" URL="../Libraries/Miscellaneous/Check for Humidity Error.vi"/>
			<Item Name="Check for stable temperature.vi" Type="VI" URL="../Libraries/Aux TE/Check for stable temperature.vi"/>
			<Item Name="Check TE Controller Ports.vi" Type="VI" URL="../Libraries/Aux TE/Check TE Controller Ports.vi"/>
			<Item Name="CommandList.vi" Type="VI" URL="../Libraries/Aux TE/CommandList.vi"/>
			<Item Name="Convert Humidity.vi" Type="VI" URL="../Libraries/Calculations/Convert Humidity.vi"/>
			<Item Name="Convert IE times to brpm.vi" Type="VI" URL="../Libraries/Calculations/Convert IE times to brpm.vi"/>
			<Item Name="Convert Termperature.vi" Type="VI" URL="../Libraries/Calculations/Convert Termperature.vi"/>
			<Item Name="Convert to Insp, Exp times.vi" Type="VI" URL="../Libraries/Calculations/Convert to Insp, Exp times.vi"/>
			<Item Name="Create Stabilizing Graph.vi" Type="VI" URL="../Libraries/Calibration/Create Stabilizing Graph.vi"/>
			<Item Name="DAQ Channels Close.vi" Type="VI" URL="../Libraries/DAQ/DAQ Channels Close.vi"/>
			<Item Name="DAQ Channels Runtime.vi" Type="VI" URL="../Libraries/DAQ/DAQ Channels Runtime.vi"/>
			<Item Name="DAQ Main.vi" Type="VI" URL="../Libraries/DAQ/DAQ Main.vi"/>
			<Item Name="DAQ Needed.ctl" Type="VI" URL="../Libraries/Controls/DAQ Needed.ctl"/>
			<Item Name="DAQ Set Digital Outputs New.vi" Type="VI" URL="../Libraries/DAQ/DAQ Set Digital Outputs New.vi"/>
			<Item Name="DAQTasks.ctl" Type="VI" URL="../Libraries/Controls/DAQTasks.ctl"/>
			<Item Name="Decode LoFlo Status Errors.vi" Type="VI" URL="../Libraries/Aux CO2/Decode LoFlo Status Errors.vi"/>
			<Item Name="Decode Temps.vi" Type="VI" URL="../Libraries/Aux TE/Decode Temps.vi"/>
			<Item Name="Enter CO2 Value.vi" Type="VI" URL="../Libraries/Calibration/Enter CO2 Value.vi"/>
			<Item Name="Format Spreadsheet Array.vi" Type="VI" URL="../Libraries/Miscellaneous/Format Spreadsheet Array.vi"/>
			<Item Name="Format Temperature Array.vi" Type="VI" URL="../Libraries/Miscellaneous/Format Temperature Array.vi"/>
			<Item Name="General SPI Write.vi" Type="VI" URL="../Libraries/DAQ/General SPI Write.vi"/>
			<Item Name="Get Correct Currents from Files.vi" Type="VI" URL="../Libraries/Initialization/Get Correct Currents from Files.vi"/>
			<Item Name="Get DAQ Offset and Set Start Values.vi" Type="VI" URL="../Libraries/DAQ/Get DAQ Offset and Set Start Values.vi"/>
			<Item Name="Get Pump Sequence.vi" Type="VI" URL="../Libraries/Miscellaneous/Get Pump Sequence.vi"/>
			<Item Name="Get System Number.vi" Type="VI" URL="../Libraries/Initialization/Get System Number.vi"/>
			<Item Name="GetBooleanSettings.vi" Type="VI" URL="../Libraries/Utilities/GetBooleanSettings.vi"/>
			<Item Name="GetGeneralSettings.vi" Type="VI" URL="../Libraries/Utilities/GetGeneralSettings.vi"/>
			<Item Name="Globals.vi" Type="VI" URL="../Libraries/Miscellaneous/Globals.vi"/>
			<Item Name="Hobbs Meter.ctl" Type="VI" URL="../Libraries/Controls/Hobbs Meter.ctl"/>
			<Item Name="IE Ratio knob.ctl" Type="VI" URL="../Libraries/Controls/IE Ratio knob.ctl"/>
			<Item Name="Initial Setting Zero Point.vi" Type="VI" URL="../Libraries/Calibration/Initial Setting Zero Point.vi"/>
			<Item Name="Initialize DAQ Channels.vi" Type="VI" URL="../Libraries/DAQ/Initialize DAQ Channels.vi"/>
			<Item Name="Initialize Fron Panels.vi" Type="VI" URL="../Libraries/Initialization/Initialize Fron Panels.vi"/>
			<Item Name="Initialize Initializing.vi" Type="VI" URL="../Libraries/Calibration/Initialize Initializing.vi"/>
			<Item Name="Initialize many displays.vi" Type="VI" URL="../Libraries/Initialization/Initialize many displays.vi"/>
			<Item Name="Initialize Stablizing Display.vi" Type="VI" URL="../Libraries/Calibration/Initialize Stablizing Display.vi"/>
			<Item Name="Initialize User Mode.vi" Type="VI" URL="../Libraries/States/Initialize User Mode.vi"/>
			<Item Name="Initializing.vi" Type="VI" URL="../Libraries/Initialization/Initializing.vi"/>
			<Item Name="Load Calibration Coefficients.vi" Type="VI" URL="../Libraries/Calibration/Load Calibration Coefficients.vi"/>
			<Item Name="Load Calibration Flow Settings Tables.vi" Type="VI" URL="../Libraries/Calibration/Load Calibration Flow Settings Tables.vi"/>
			<Item Name="Log.vi" Type="VI" URL="../Libraries/States/Log.vi"/>
			<Item Name="Logging.vi" Type="VI" URL="../Libraries/States/Logging.vi"/>
			<Item Name="Logging2.vi" Type="VI" URL="../Libraries/States/Logging2.vi"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="lvStorage.dll" Type="Document" URL="lvStorage.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Main Initialize.vi" Type="VI" URL="../Libraries/Initialization/Main Initialize.vi"/>
			<Item Name="Monitor Step 1.vi" Type="VI" URL="../Libraries/States/Monitor Step 1.vi"/>
			<Item Name="Monitoring.vi" Type="VI" URL="../Libraries/States/Monitoring.vi"/>
			<Item Name="More Startup.vi" Type="VI" URL="../Libraries/Initialization/More Startup.vi"/>
			<Item Name="nilvaiu.dll" Type="Document" URL="nilvaiu.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="PAHS Config Setup.vi" Type="VI" URL="../Libraries/Initialization/PAHS Config Setup.vi"/>
			<Item Name="Parse CO2.vi" Type="VI" URL="../Libraries/Aux CO2/Parse CO2.vi"/>
			<Item Name="Parse Waveforms old.vi" Type="VI" URL="../Libraries/Miscellaneous/Parse Waveforms old.vi"/>
			<Item Name="Processed Variables.ctl" Type="VI" URL="../Libraries/Controls/Processed Variables.ctl"/>
			<Item Name="Pump Settings.ctl" Type="VI" URL="../Libraries/Controls/Pump Settings.ctl"/>
			<Item Name="Queues And Others.ctl" Type="VI" URL="../Libraries/Controls/Queues And Others.ctl"/>
			<Item Name="Read Cal Coefficients File.vi" Type="VI" URL="../Libraries/Calibration/Read Cal Coefficients File.vi"/>
			<Item Name="ReadBoleans.vi" Type="VI" URL="../Libraries/Utilities/ReadBoleans.vi"/>
			<Item Name="ReadConfigFile.vi" Type="VI" URL="../Libraries/Initialization/ReadConfigFile.vi"/>
			<Item Name="ReadFromSpreadsheet.vi" Type="VI" URL="../Libraries/Miscellaneous/ReadFromSpreadsheet.vi"/>
			<Item Name="ReadParameters.vi" Type="VI" URL="../Libraries/Utilities/ReadParameters.vi"/>
			<Item Name="Real Time Mode.vi" Type="VI" URL="../Libraries/States/Real Time Mode.vi"/>
			<Item Name="Restore Copy of  Cal Coefficients.vi" Type="VI" URL="../Libraries/Calibration/Restore Copy of  Cal Coefficients.vi"/>
			<Item Name="Run Till Stable2.vi" Type="VI" URL="../Libraries/Calibration/Run Till Stable2.vi"/>
			<Item Name="RunTime.rtm" Type="Document" URL="../RunTime.rtm"/>
			<Item Name="Save Copy of Cal Coefficients.vi" Type="VI" URL="../Libraries/Calibration/Save Copy of Cal Coefficients.vi"/>
			<Item Name="SendDIOWithSemaphore.vi" Type="VI" URL="../Libraries/DAQ/SendDIOWithSemaphore.vi"/>
			<Item Name="Serial Config.vi" Type="VI" URL="../Libraries/Initialization/Serial Config.vi"/>
			<Item Name="Serial Visa Control.ctl" Type="VI" URL="../Libraries/Controls/Serial Visa Control.ctl"/>
			<Item Name="SerialPortControl.ctl" Type="VI" URL="../Libraries/Controls/SerialPortControl.ctl"/>
			<Item Name="Set All SPI Bits High With CS.vi" Type="VI" URL="../Libraries/DAQ/Set All SPI Bits High With CS.vi"/>
			<Item Name="Set an Clear Bits.vi" Type="VI" URL="../Libraries/DAQ/Set an Clear Bits.vi"/>
			<Item Name="Set DAQ and Wait.vi" Type="VI" URL="../Libraries/DAQ/Set DAQ and Wait.vi"/>
			<Item Name="Set DAQ Settings and Wait.vi" Type="VI" URL="../Libraries/DAQ/Set DAQ Settings and Wait.vi"/>
			<Item Name="Set Front Panel Visibility.vi" Type="VI" URL="../Libraries/Calibration/Set Front Panel Visibility.vi"/>
			<Item Name="Set Gas Tank.vi" Type="VI" URL="../Libraries/DAQ/Set Gas Tank.vi"/>
			<Item Name="Set Insp-Exp Phase.vi" Type="VI" URL="../Libraries/Miscellaneous/Set Insp-Exp Phase.vi"/>
			<Item Name="Set LED Status.vi" Type="VI" URL="../Libraries/Utilities/Set LED Status.vi"/>
			<Item Name="Set SPI Clock High.vi" Type="VI" URL="../Libraries/DAQ/Set SPI Clock High.vi"/>
			<Item Name="Set SPI Data Bit Low.vi" Type="VI" URL="../Libraries/DAQ/Set SPI Data Bit Low.vi"/>
			<Item Name="Set Tank Display.vi" Type="VI" URL="../Libraries/Miscellaneous/Set Tank Display.vi"/>
			<Item Name="Set Zero.vi" Type="VI" URL="../Libraries/Miscellaneous/Set Zero.vi"/>
			<Item Name="Setting Zero Point.vi" Type="VI" URL="../Libraries/Calibration/Setting Zero Point.vi"/>
			<Item Name="Setup Capnograph.vi" Type="VI" URL="../Libraries/Miscellaneous/Setup Capnograph.vi"/>
			<Item Name="Setup DACs No Front Panel Using Dac Settings.vi" Type="VI" URL="../Libraries/DAQ/Setup DACs No Front Panel Using Dac Settings.vi"/>
			<Item Name="Setup DACs_not as old.vi" Type="VI" URL="../Libraries/DAQ/Setup DACs_not as old.vi"/>
			<Item Name="SPI bit bang write.vi" Type="VI" URL="../Libraries/DAQ/SPI bit bang write.vi"/>
			<Item Name="SPI Set DAC Using Current only No Front Panel Using DAC Settings.vi" Type="VI" URL="../Libraries/DAQ/SPI Set DAC Using Current only No Front Panel Using DAC Settings.vi"/>
			<Item Name="Stabilizing.vi" Type="VI" URL="../Libraries/Calibration/Stabilizing.vi"/>
			<Item Name="StartScreen.vi" Type="VI" URL="../Libraries/Initialization/StartScreen.vi"/>
			<Item Name="Store Calibration Coefficients.vi" Type="VI" URL="../Libraries/Calibration/Store Calibration Coefficients.vi"/>
			<Item Name="Store Temperature Profile.vi" Type="VI" URL="../Libraries/Miscellaneous/Store Temperature Profile.vi"/>
			<Item Name="Storing Calibration Coefficients.vi" Type="VI" URL="../Libraries/Calibration/Storing Calibration Coefficients.vi"/>
			<Item Name="Storing Calibration Coefficients2.vi" Type="VI" URL="../Libraries/Calibration/Storing Calibration Coefficients2.vi"/>
			<Item Name="Stuff Cluster.vi" Type="VI" URL="../Libraries/Calibration/Stuff Cluster.vi"/>
			<Item Name="Switch IE Phase.vi" Type="VI" URL="../Libraries/DAQ/Switch IE Phase.vi"/>
			<Item Name="TE Loop.vi" Type="VI" URL="../Libraries/Aux TE/TE Loop.vi"/>
			<Item Name="Temperature Cycle.ctl" Type="VI" URL="../Libraries/Controls/Temperature Cycle.ctl"/>
			<Item Name="Temperature Source.ctl" Type="VI" URL="../Libraries/Controls/Temperature Source.ctl"/>
			<Item Name="TempSequence.vi" Type="VI" URL="../Libraries/Utilities/TempSequence.vi"/>
			<Item Name="Threads.vi" Type="VI" URL="../Libraries/Miscellaneous/Threads.vi"/>
			<Item Name="Turn Air Pump On or Off.vi" Type="VI" URL="../Libraries/DAQ/Turn Air Pump On or Off.vi"/>
			<Item Name="Turn Humidity On or Off.vi" Type="VI" URL="../Libraries/DAQ/Turn Humidity On or Off.vi"/>
			<Item Name="Turn Solenoid 1 On or Off.vi" Type="VI" URL="../Libraries/DAQ/Turn Solenoid 1 On or Off.vi"/>
			<Item Name="Turn Solenoid 2 On or Off.vi" Type="VI" URL="../Libraries/DAQ/Turn Solenoid 2 On or Off.vi"/>
			<Item Name="Turn Test Light On or Off.vi" Type="VI" URL="../Libraries/DAQ/Turn Test Light On or Off.vi"/>
			<Item Name="UI Settings.ctl" Type="VI" URL="../Libraries/Controls/UI Settings.ctl"/>
			<Item Name="Update Front Panel.vi" Type="VI" URL="../Libraries/Miscellaneous/Update Front Panel.vi"/>
			<Item Name="User Calibration New.vi" Type="VI" URL="../Libraries/Calibration/User Calibration New.vi"/>
			<Item Name="UserMode.vi" Type="VI" URL="../Libraries/States/UserMode.vi"/>
			<Item Name="View and Edit Calibration Coefficients.vi" Type="VI" URL="../Libraries/Calibration/View and Edit Calibration Coefficients.vi"/>
			<Item Name="Wait for DOs to complete.vi" Type="VI" URL="../Libraries/DAQ/Wait for DOs to complete.vi"/>
			<Item Name="Write Coefficient Info to Calibration Screen.vi" Type="VI" URL="../Libraries/Miscellaneous/Write Coefficient Info to Calibration Screen.vi"/>
			<Item Name="Write Config Data Table.vi" Type="VI" URL="../Libraries/Initialization/Write Config Data Table.vi"/>
			<Item Name="Write Out Parsed Values.vi" Type="VI" URL="../Libraries/Miscellaneous/Write Out Parsed Values.vi"/>
			<Item Name="Write Some Info.vi" Type="VI" URL="../Libraries/Initialization/Write Some Info.vi"/>
			<Item Name="Write Test Settings to Front Panels.vi" Type="VI" URL="../Libraries/Initialization/Write Test Settings to Front Panels.vi"/>
			<Item Name="WriteConfigFile.vi" Type="VI" URL="../Libraries/Initialization/WriteConfigFile.vi"/>
			<Item Name="WriteToSpreadsheet.vi" Type="VI" URL="../Libraries/Initialization/WriteToSpreadsheet.vi"/>
			<Item Name="Zeroing.vi" Type="VI" URL="../Libraries/States/Zeroing.vi"/>
		</Item>
